...
namespace HCQ2_IBLL
{
    ...
    public partial interface IT_PageFolderBLL
    {
        ...
        /// </summary>
        /// <returns></returns>
        List<HCQ2_Model.TreeModel.TreeTableAttribute> GetMenuDataByPid(int id,string type,string sm_code);
        /// <summary>
        ///  保存编辑菜单
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        List<HCQ2_Model.ExtendsionModel.T_PageFolderModel> GetMainMenu(string sm_code);
    }
}
