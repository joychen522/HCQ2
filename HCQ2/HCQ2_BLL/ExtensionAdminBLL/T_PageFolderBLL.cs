    ...
    public partial class T_PageFolderBLL : IT_PageFolderBLL
    {
        ...
        public bool EditPageFolder(T_PageFolder folder, int id)
        {
            ...
            int tempCopunt = DBSession.IT_PageFolderDAL.Modify(folder, s => s.folder_id == id, "folder_name",
                "folder_image","folder_url","sm_code", "is_Bus", "Bus_Code");
            return true;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<T_PageFolderModel> GetMainMenu(string sm_code)
        {
            List<T_PageFolder> strTemp = HCQ2UI_Helper.Session.SysPermissSession.MenusList;
            ...
            {
                var str = strTemp.Where(s => s.sm_code.Equals(sm_code));
                if (null != str)
                    list = str.ToList();
            }
            else
            {
                ...
                list = strTemp.Where(s => cList.Contains(s.sm_code)).ToList();   
            }
